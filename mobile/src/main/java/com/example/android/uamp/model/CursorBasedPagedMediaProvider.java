 ...
 */
public class CursorBasedPagedMediaProvider  {

    private final Cursor mCursor;

    public CursorBasedPagedMediaProvider(Context applicationContext) {
    ...
    public List<BrowsableItem> getSongsAtRange(int startPosition, int endPosition) {
