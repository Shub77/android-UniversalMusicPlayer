 ...
 */
public class CursorBasedPagedAlbumByIdMediaProvider {

    private final Cursor mCursor;

    public CursorBasedPagedAlbumByIdMediaProvider(Context applicationContext, String mediaId) {
    ...
    public List<BrowsableItem> getTracksOnAlbumByIdPage(int startPosition, int endPosition) {
    ...
    @Nullable
    private String[] getSelectionArgs(String albumId) {
        return new String[] {albumId};
    }

    @Nullable
    private String getSortOrder() {
        return MediaStore.Audio.Media.ALBUM + " COLLATE LOCALIZED ASC";
    }
}
